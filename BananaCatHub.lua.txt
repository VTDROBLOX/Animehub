...
-- Nhận giá trị từ getgenv() (truyền từ script creator)
local _title = (getgenv and getgenv().name) or "VTD roblox"
local _image = (getgenv and getgenv().logo) or "rbxassetid://13525281858"
local _color = (getgenv and getgenv().color) or Color3.fromRGB(255, 20, 147)
...
Library:Notify({
    Title = _title,
    Description = "Chào mừng! Script đã được load thành công.\nNhấn nút góc trái màn hình để mở GUI.",
    Duration = 4
})
...
Tabs.Info:AddButton({
    ...
    ["Description"] = "Discord",
    ["Callback"] = function()
        setclipboard(tostring("https://discord.gg/4ymUPpKH2E"))
    end
})
Tabs.Info:AddButton({
    ["Title"] = "VTD roblox",
    ["Description"] = "Youtube",
    ["Callback"] = function()
        setclipboard(tostring("https://youtube.com/@vtdroblox1"))
    end
})
Tabs.Info:AddButton({
    ["Title"] = "VTD roblox",
